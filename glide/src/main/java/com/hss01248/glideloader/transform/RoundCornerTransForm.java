...
public class RoundCornerTransForm implements Transformation<Bitmap> {
    ...
    private int mMargin;
    private RoundCornerTransForm.CornerType mCornerType;

    public RoundCornerTransForm(Context context, int radius, int margin) {
        this(context, radius, margin, RoundCornerTransForm.CornerType.ALL);
    }

    public RoundCornerTransForm(BitmapPool pool, int radius, int margin) {
        this(pool, radius, margin, RoundCornerTransForm.CornerType.ALL);
    }

    public RoundCornerTransForm(Context context, int radius, int margin,
                                RoundCornerTransForm.CornerType cornerType) {
    ...
    public Resource<Bitmap> transform(Resource<Bitmap> resource, int outWidth, int outHeight) {
        Bitmap bitmap = BaseTransForm.scale(resource,outWidth,outHeight);
