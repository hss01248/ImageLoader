 ...
 */
public abstract class GSYBaseActivityDetail2<T extends GSYBaseVideoPlayer> extends AppCompatActivity implements VideoAllCallBack {
    ...
    public static boolean supportPlayingBackground = true;
